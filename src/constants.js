module.exports = {
    PLANETAS: [
        [require('swisseph').SE_SUN, 'Sol', 'Lumiar', 6],
        [require('swisseph').SE_MOON, 'Lua', 'Lumiar', 6],
        [require('swisseph').SE_MERCURY, 'Mercúrio', 'Pessoal', 4],
        [require('swisseph').SE_VENUS, 'Vênus', 'Pessoal', 4],
        [require('swisseph').SE_MARS, 'Marte', 'Pessoal', 4],
        [require('swisseph').SE_JUPITER, 'Júpiter', 'Social', 2],
        [require('swisseph').SE_SATURN, 'Saturno', 'Social', 2],
        [require('swisseph').SE_URANUS, 'Urano', 'Geracional', 1],
        [require('swisseph').SE_NEPTUNE, 'Netuno', 'Geracional', 1],
        [require('swisseph').SE_PLUTO, 'Plutão', 'Geracional', 1],
